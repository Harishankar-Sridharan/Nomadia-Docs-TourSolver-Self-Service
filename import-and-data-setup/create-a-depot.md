...
1. From the **Actions menu**, click **Manage Depots**

![](<../.gitbook/assets/Unknown image (1)>)

## Understanding Depot Details
...
1. In the **General** section, enter the required basic information.
...
1. To add or edit quantity details, click the **plus symbol** located at the bottom right corner.
2. Update the inventory details.
...
1. Depot has been created successfully
...
1. Click **Import**, then select **Browse Excel** to choose a file and import it, or simply **drag and drop** your file into the upload area.
