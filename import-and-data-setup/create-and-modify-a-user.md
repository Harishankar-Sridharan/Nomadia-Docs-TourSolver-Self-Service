...
1. Fill in Access Details: In the **Access** section, enter the required information:

* **Login ID**
* **First Name**
* **Last Name**

2. **Set Access Type and Password:**
...
1. Define Roles and Rights: In the **Roles and Rights** section, enable all necessary roles, such as **administrator**, **optimization**, or **depot**. In the roles and rights, enable all the roles and rights such as administrator, optimization, depot etc.
2. Assign Agencies: In the **Agencies** section, click on the agencies you need to assign, and then Click the **right arrow** to move them into the assigned list.

![](<../.gitbook/assets/Unknown image (13)>)



1. \*\*Plan Slot Time: In the **Planning** section, Click the **day and timing** to set the desired slot time, and then click **update**.

![](<../.gitbook/assets/Unknown image (14)>)



1. \*\*Schedule Days Off (Optional): In the **Days Off** section, you can plan future time off:
...
1. Save the User: After filling in all required information, Click on **Save** to finalize the creation.
...
1. Modify Information: Go through the different sections (Access, Roles and Rights, Planning, etc.) and modify the existing information as needed.
2. Save Changes: Once you have updated the necessary information, Click on **Save** to complete the modification.
...
* ⚠ Password Clarity: When setting a password, make sure it meets the security criteria: it must be **8 characters** long and include at least **one numeric** character and **one special character**.
* ⚠ Avoid Duplicate Emails: If you try to enter an email address that is already in use by another user, the system will display an error message stating that **"the email id is already used"**. You will need to use a unique email address to proceed.
