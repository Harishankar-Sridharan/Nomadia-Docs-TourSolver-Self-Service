...
You can start modifying resources and constraints directly from the system’s homepage.

**Access My Deliverers**

![](../.gitbook/assets/ResourceandVehicleManagement-ModifyingaResourceandAssociatedConstraints_timestamp_0_to_07–0_to_11.gif)

**Choose Your Modification Method** You have two primary ways to modify a resource: **team-wise** (affecting a group) or **individually**.

![](../.gitbook/assets/ResourceandVehicleManagement-ModifyingaResourceandAssociatedConstraints_timestamp_0_to_15–0_to_20.gif)

Click the edit (pencil) icon next to the name

![](../.gitbook/assets/ResourceandVehicleManagement-ModifyingaResourceandAssociatedConstraints_timestamp_0_to_28–0_to_38.gif)

You can start modifying the associated constraints.
...
#### 4.1. Modifying Departure and Arrival Locations
...
![](../.gitbook/assets/ResourceandVehicleManagement-ModifyingaResourceandAssociatedConstraints_timestamp_0_to_51–1_to_00.gif)

2. **Update Address:** Modify the departure address as needed.

![](../.gitbook/assets/ResourceandVehicleManagement-ModifyingaResourceandAssociatedConstraints_timestamp_1_to_12–1_to_18.gif)
...
#### 4.2. Updating Vehicle Capacities (Weight)

1. You can manage the maximum weight a resource's vehicle can carry.

![](../.gitbook/assets/ResourceandVehicleManagement-ModifyingaResourceandAssociatedConstraints_timestamp_1_to_40–1_to_43.gif)

2. **Modify Value:** Modify the value of the weight. You can input this value in **kilograms** or **grams**.

![](../.gitbook/assets/ResourceandVehicleManagement-ModifyingaResourceandAssociatedConstraints_timestamp_1_to_53–2_to_01.gif)

#### 4.3. Modifying Planning and Work Times
...
1. **Access Planning:** Tap on **Planning**.
2. **Access Time Slot:** In Simple View, tap on the **time slot**.
3. **Edit Work Slot:** Tap on **Edit Workslot**.
4. **Set Start and End Times:** Modify the start time and the end time.
5. **Confirm:** Tap on **Edit**.
...
![](../.gitbook/assets/ResourceandVehicleManagement-ModifyingaResourceandAssociatedConstraints_timestamp_3_to_33–3_to_43.gif)
...
#### 4.4. Saving All Modifications

Once you have completed all necessary changes across Departure, Arrival, Capacity, and Planning:

![](../.gitbook/assets/ResourceandVehicleManagement-ModifyingaResourceandAssociatedConstraints_timestamp_3_to_53–3_to_58.gif)

The changes will be displayed successfully

![](../.gitbook/assets/ResourceandVehicleManagement-ModifyingaResourceandAssociatedConstraints_timestamp_3_to_58–4_to_04.gif)
