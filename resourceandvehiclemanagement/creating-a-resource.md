...
Welcome! This guide will walk you through the simple steps of defining a **Resource** (for example a delivery staff member or a driver) within TourSolver. The goal is to make sure you can set up your team members accurately and confidently, allowing the system to manage vehicle assignments, work schedules, and time off effectively.
...
* **Resource Details (General Info):** identify the staff member by name and specify their starting point, the **departure location**.
* **Vehicles Tab:** define the primary way the staff member travels by selecting the **means of transportation**.
* **Vehicles Capacities Tab:** define what the resource (or their assigned vehicle) can carry. You can **add vehicle capacities** to ensure constraints are met during planning.
* **Working Time and Planning Tabs:** define the staff member's availability, include whether the **automatic start time** feature is active, specific work slots, and schedule **lunch breaks**.
* **Days Off Tab:** schedule specific dates when the resource will be unavailable.
...
* Go to the **Vehicles Capacities tab**.
* Click on the **plus symbol (+)** located at the bottom corner.
* Add the necessary vehicle capacities in the available fields.
