...
TourSolver is designed to perform optimally on modern web browsers. The application has been tested and validated with the following versions:

* Google Chrome: version 85 and above
* Mozilla Firefox: version 77 and above
* Microsoft Edge: version 85 and above
* Apple Safari: version 13.1 and above

Using one of the above browsers ensures the best performance and full access to TourSolver features.
...
Use the following URL to begin the sign-up process for TourSolver.

[Access/TourSolver](https://app.geoconcept.com/ToursolverCloud/ts/trsolver/home)

If you already have the credentials, you can log in and skip this guide

If you don’t have an account, click **Sign up now**.

![](../.gitbook/assets/GettingStarted-SignupProcess_timestamp_0_to_10–0_to_18.gif)

&#x20;   Enter the **Valid email address**.&#x20;

&#x20;   Click on **Send Verification code**

![](../.gitbook/assets/GettingStarted-SignupProcess_timestamp_0_to_18–0_to_26.gif)

&#x20;    Type the **Verification code** received in your email and click on **Verify code**

<figure><img src="../.gitbook/assets/msedge_lNQZAnpeoh (1).png" alt=""><figcaption></figcaption></figure>

&#x20;   **Expected Outcome:** Upon successful verification, a confirmation message appears  &#x20;

&#x20;   stating, _**“Your email has been verified**.”_

<figure><img src="../.gitbook/assets/msedge_irMn6kRZzt.png" alt=""><figcaption></figcaption></figure>
...
2.  **Create Your Password:** Enter your chosen password.
    ...
    ⚠️ **Warning: Password Requirements** Your password must be strong! Ensure it includes all of the following:
...
<figure><img src="../.gitbook/assets/msedge_ct1Bzp6Hqc.png" alt=""><figcaption></figcaption></figure>
...
![](../.gitbook/assets/GettingStarted-SignupProcess_timestamp_2_to_08–2_to_23.gif)

Review the **End user agreement** and click the **Check box.**&#x20;

<figure><img src="../.gitbook/assets/Photos_vpJ69a4v10.png" alt=""><figcaption></figcaption></figure>

Click on **Let’s Go**

![](../.gitbook/assets/GettingStarted-SignupProcess_timestamp_2_to_38–2_to_43.gif)
...
During the trial period, you can explore the platform with the following limits:

* Up to 5 drivers
* Up to 5 route optimizations per day
* Up to 250 deliveries per optimization

These limits allow you to test real-world scenarios and experience the platform’s full functionality without any complex setup.
