...
<table data-header-hidden><thead><tr><th valign="top"></th><th valign="top"></th></tr></thead><tbody><tr><td valign="top">Feature</td><td valign="top">Context and Benefit</td></tr><tr><td valign="top"><p> </p><p>Address Modification</p></td><td valign="top">Allows you to quickly correct or update the location of a specific delivery using the Address field</td></tr><tr><td valign="top"><p> </p><p> </p><p> </p><p>Re-optimization</p></td><td valign="top">Once you save the new address, the system automatically recalculates the optimal route. This means the new distance and the travel time will be recalculated instantly after the re-optimization.</td></tr></tbody></table>



## How to Modify a Delivery Address and Update the Route
