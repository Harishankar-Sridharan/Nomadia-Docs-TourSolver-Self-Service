...
<figure><img src="../.gitbook/assets/msedge_M89P5p6ely.png" alt=""><figcaption></figcaption></figure>

2. A mapping window will appear, prompting you to match your Excel fields with the required server fields.

<figure><img src="../.gitbook/assets/ImportandDataSetup-ImportofDeliveries_timestamp_1_to_19–1_to_25.gif" alt=""><figcaption></figcaption></figure>
...
4.  **To reset or adjust a field mapping** (using Customer ID and Name as an example):
    ...
    * If a field is currently mapped, you may choose to **ignore** it.
    ...
    <figure><img src="../.gitbook/assets/ImportandDataSetup-ImportofDeliveries_timestamp_1_to_39–1_to_41.gif" alt=""><figcaption></figcaption></figure>

    * Click on **show all** to view all possible field options.

    <figure><img src="../.gitbook/assets/ImportandDataSetup-ImportofDeliveries_timestamp_1_to_42–1_to_44.gif" alt=""><figcaption></figcaption></figure>

    * Click on **customer ID** option to map the customer ID column.

    <figure><img src="../.gitbook/assets/ImportandDataSetup-ImportofDeliveries_timestamp_1_to_46–1_to_49.gif" alt=""><figcaption></figcaption></figure>

    * If you need to change the Name field, Click on **ignore** under the current name mapping.

    <figure><img src="../.gitbook/assets/ImportandDataSetup-ImportofDeliveries_timestamp_1_to_51–1_to_53.gif" alt=""><figcaption></figcaption></figure>

    * Click on **name** to complete the mapping for the name field.

    <figure><img src="../.gitbook/assets/ImportandDataSetup-ImportofDeliveries_timestamp_1_to_54–1_to_58.gif" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/ImportandDataSetup-ImportofDeliveries_timestamp_2_to_07–2_to_10.gif" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/msedge_PM2SIoQJPH.png" alt=""><figcaption></figcaption></figure>

5. Click on **optimize my routes** to begin the route calculation.

<figure><img src="../.gitbook/assets/ImportandDataSetup-ImportofDeliveries_timestamp_2_to_24–2_to_26.gif" alt=""><figcaption></figcaption></figure>

6. Once you start the optimization, the system will begin the calculation process.

<figure><img src="../.gitbook/assets/ImportandDataSetup-ImportofDeliveries_timestamp_2_to_28–2_to_32.gif" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/ImportandDataSetup-ImportofDeliveries_timestamp_2_to_12–2_to_16.gif" alt=""><figcaption></figcaption></figure>

* **Gray color** indicates that the location was **not** geocoded.&#x20;

<figure><img src="../.gitbook/assets/ImportandDataSetup-ImportofDeliveries_timestamp_2_to_17–2_to_20.gif" alt=""><figcaption></figcaption></figure>
